...
For these reasons, compared to conventional takeoff and landing (CTOL) aircraft of the same sive, STOL vehicles tend to be lightly wing loaded, have high power-weight ratios, and have large and complex high-lift systems to increase $CL_{max}$ as much as possible.  To first order, high power-to-weight ratios and complex high-lift systems both add significant weight to the system, as well as some second-order effects on efficiency.  For a given aircraft, decreasing wing loading below its optimal value will limit the top speed of the vehicle, as well as making it more sensitive to wind gusts.  It will also increase the power required to cruise at a given speed, requiring additional fuel or batteries.  For these reasons, and since short field capability is not required at most airports, STOL aircraft have not widely adopted outside of the bush pilot community. 
